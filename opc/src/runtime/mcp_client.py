...
class McpClientManager:
    ...
    async def _connect_sse(self, server_name: str, config: ServerConfig) -> None:
        ...
        # Security: Validate URL to prevent SSRF attacks (F1 mitigation, CVSS 6.8)
        from opc.src.security.validators import validate_url
        validate_url(config.url, field_name="server_url")
